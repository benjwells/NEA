...
input = [
  pygame.Rect(100, 100, box_width, box_height),  # Gravity
  pygame.Rect(350, 100, box_width, box_height),  # Initial Velocity
  pygame.Rect(600, 100, box_width, box_height),  # Angle
